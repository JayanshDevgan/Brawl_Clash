        ...
        creatures = {
            fire_drake = {
                ...
                attacks = {
                    ...
                    { name = "Drake’s Inferno", damage = 35, aoe = true, usable = 3 },
                    { name = "Blazing Roar", damage = 40, reduce_defense = true, usable = 2 },
                    { name = "Pyro Dive", damage = 50, usable = 2 },
                    { name = "Crimson Cataclysm (Ultimate)", damage = 100, aoe = true, usable = 1 }
                }
            },
            inferno_wolf = {
                name = "Inferno Wolf",
                ...
                attacks = {
                    ...
                    { name = "Lava Howl", damage = 30, aoe = true, usable = 4 },
            ...
            flame_scorpion = {
                ...
                defense = 30,
                attacks = {
                    { name = "Scorching Stinger", damage = 20, poison = true, usable = 5 },
                    { name = "Ash Volley", damage = 30, aoe = true, usable = 4 },
                    { name = "Magma Crush", damage = 35, usable = 3 },
                    { name = "Pyro Shield", reduce_damage = 50, duration = 1, usable = 2 },
                    { name = "Infernal Stinger (Ultimate)", damage = 10, poison = true, aoe = true, usable = 1 }
                }
            },
            lava_tiger = {
                name = "Lava Tiger",
                ...
                attacks = {
                    ...
                    { name = "Fiery Growl", reduce_attack = true, usable = 3 },
                    { name = "Lava Swipe", damage = 50, usable = 2 },
                    { name = "Volcanic Fury (Ultimate)", damage = 100, aoe = true, usable = 1 }
                }
            },
            ember_phoenix = {
                name = "Ember Phoenix",
                ...
                attacks = {
                    ...
                    { name = "Blazing Wings", damage = 30, aoe = true, usable = 4 },
                    { name = "Fire Rebirth", heal = 20, usable = 3 },
                    { name = "Infernal Screech", damage = 45, usable = 2 },
                    { name = "Eternal Blaze (Ultimate)", damage = 120, heal = true, usable = 1 }
                }
            },
            magma_serpent = {
                name = "Magma Serpent",
                ...
                attacks = {
                    ...
                    { name = "Fire Breath", damage = 35, aoe = true, usable = 4 },
                    { name = "Molten Strike", damage = 40, usable = 3 },
                    { name = "Blistering Tail", damage = 50, usable = 2 },
                    { name = "Infernal Vortex (Ultimate)", damage = 110, stun = true, usable = 1 }
                }
            },
            pyro_crab = {
                name = "Pyro Crab",
            ...
            smoldering_wasp = {
                ...
                defense = 15,
                attacks = {
                    { name = "Fiery Sting", damage = 15, poison = true, usable = 7 },
                    { name = "Inferno Swarm", damage = 25, aoe = true, usable = 4 },
                    { name = "Burning Dive", damage = 40, usable = 3 },
                    { name = "Wing Cyclone", damage = 50, usable = 2 },
                    { name = "Ash Cloud (Ultimate)", damage = 100, blind = true, duration = 2, usable = 1 }
                }
            },
            ash_demon = {
                name = "Ash Demon",
                ...
                attacks = {
                    ...
                    { name = "Hellfire Blaze", damage = 35, aoe = true, usable = 4 },
                    { name = "Demonic Roar", reduce_speed = true, usable = 3 },
                    { name = "Ash Storm", damage = 45, usable = 2 },
                    { name = "Demonic Inferno (Ultimate)", damage = 120, aoe = true, usable = 1 }
                }
            },
            fire_elemental = {
                name = "Fire Elemental",
                ...
                attacks = {
                    ...
                    { name = "Eruption Nova (Ultimate)", damage = 100, aoe = true, usable = 1 }
                }
            }
        }
    },
        ...
        creatures = {
            aqua_shark = {
                ...
                attacks = {
                    ...
                    { name = "Ocean Frenzy (Ultimate)", damage = 110, aoe = true, usable = 1 }
                }
            },
            tidal_turtle = {
                name = "Tidal Turtle",
                ...
                attacks = {
                    ...
                    { name = "Wave Crash", damage = 35, aoe = true, usable = 4 },
                    { name = "Aqua Armor", absorb = 40, duration = 2, usable = 3 },
                    { name = "Tsunami Charge", damage = 50, usable = 2 },
                    { name = "Tidal Surge (Ultimate)", damage = 100, aoe = true, heal = 20, usable = 1 }
                }
            },
            frost_leviathan = {
                ...
                attacks = {
                    ...
                    { name = "Frozen Breath", damage = 30, freeze = true, duration = 1, usable = 5 },
                    { name = "Arctic Roar", reduce_speed = true, usable = 3 },
                    { name = "Glacial Swipe", damage = 50, usable = 2 },
                    { name = "Polar Cataclysm (Ultimate)", damage = 120, freeze = true, aoe = true, usable = 1 }
                }
            },
            coral_serpent = {
                name = "Coral Serpent",
                ...
                attacks = {
                    ...
                    { name = "Coral Tsunami (Ultimate)", damage = 110, aoe = true, usable = 1 }
                }
            },
            ocean_spirit = {
                name = "Ocean Spirit",
                ...
                attacks = {
                    ...
                    { name = "Spirit Torrent", damage = 30, aoe = true, usable = 4 },
            ...
            tsunami_crab = {
                ...
                attacks = {
                    ...
                    { name = "Aqua Cyclone", damage = 30, aoe = true, usable = 4 },
                    { name = "Shell Barrier", reduce_damage = 50, duration = 1, usable = 3 },
                    { name = "Hydro Claw Strike", damage = 50, usable = 2 },
                    { name = "Ocean Rage (Ultimate)", damage = 110, stun = true, usable = 1 }
                }
            },
            abyssal_jellyfish = {
                ...
                attacks = {
                    ...
                    { name = "Electric Pulse", damage = 30, paralyze = true, duration = 1, usable = 5 },
                    { name = "Abyssal Shield", absorb = 30, duration = 3, usable = 3 },
                    { name = "Hydro Shock", damage = 45, usable = 2 },
                    { name = "Abyssal Torrent (Ultimate)", damage = 120, aoe = true, paralyze = true, duration = 1, usable = 1 }
                }
            },
            wave_wyvern = {
                name = "Wave Wyvern",
                ...
                attacks = {
                    ...
                    { name = "Water Spiral", damage = 30, aoe = true, usable = 4 },
                    { name = "Wyvern Roar", reduce_attack = 20, usable = 3 },
                    { name = "Hydro Dive", damage = 50, usable = 2 },
                    { name = "Wyvern’s Wrath (Ultimate)", damage = 110, aoe = true, usable = 1 }
                }
            },
            water_wisp = {
                name = "Water Wisp",
                ...
                attacks = {
                    ...
                    { name = "Flowing Form", dodge_next = true, usable = 3 },
                    { name = "Water Arrow", damage = 45, usable = 2 },
                    { name = "Torrent Surge (Ultimate)", damage = 100, grant_dodge = true, usable = 1 }
                }
            },
            ice_golem = {
                name = "Ice Golem",
                ...
                attacks = {
                    ...
                    { name = "Glacial Impact", damage = 35, aoe = true, usable = 3 },
                    { name = "Crystal Hammer", damage = 50, usable = 2 },
                    { name = "Arctic Annihilation (Ultimate)", damage = 120, freeze = true, aoe = true, usable = 1 }
                }
            }
        }
    },
        ...
        creatures = {
            stone_golem = {
                ...
                attacks = {
                    ...
                    { name = "Quake Stomp", damage = 40, aoe = true, usable = 3 },
                    { name = "Boulder Toss", damage = 50, usable = 2 },
                    { name = "Terra Smash (Ultimate)", damage = 120, aoe = true, usable = 1 }
                }
            },
            forest_guardian = {
                ...
                attacks = {
                    ...
                    { name = "Root Grasp", damage = 25, slow = true, usable = 5 },
                    { name = "Thorn Wall", reflect_damage = 25, duration = 2, usable = 3 },
                    { name = "Leaf Barrage", damage = 45, usable = 2 },
                    { name = "Nature's Fury (Ultimate)", damage = 100, aoe = true, heal_all = 20, usable = 1 }
                }
            },
            rock_serpent = {
                name = "Rock Serpent",
                ...
                attacks = {
                    ...
                    { name = "Stone Coil", damage = 30, paralyze = true, duration = 1, usable = 5 },
                    { name = "Petrify", reduce_attack = 20, usable = 3 },
                    { name = "Crushing Fang", damage = 50, usable = 2 },
                    { name = "Serpent's Quake (Ultimate)", damage = 110, aoe = true, stun = true, duration = 1, usable = 1 }
                }
            },
            sand_beetle = {
                name = "Sand Beetle",
                ...
                attacks = {
                    ...
                    { name = "Desert Fury (Ultimate)", damage = 110, aoe = true, usable = 1 }
                }
            },
            iron_rhino = {
                name = "Iron Rhino",
                ...
                attacks = {
                    ...
                    { name = "Charge Smash", damage = 35, aoe = true, usable = 4 },
                    { name = "Iron Defense", reduce_damage = 40, duration = 2, usable = 3 },
                    { name = "Stampede", damage = 50, usable = 2 },
                    { name = "Titan Charge (Ultimate)", damage = 120, aoe = true, stun = true, duration = 1, usable = 1 }
                }
            },
            crystal_bear = {
                name = "Crystal Bear",
                ...
                attacks = {
                    ...
                    { name = "Crystal Avalanche (Ultimate)", damage = 120, freeze = true, aoe = true, duration = 1, usable = 1 }
                }
            },
            mud_basilisk = {
                name = "Mud Basilisk",
                ...
                attacks = {
                    ...
                    { name = "Quagmire Grip", damage = 25, slow = true, duration = 1, usable = 5 },
                    { name = "Mud Barrier", reduce_damage = 30, duration = 2, usable = 3 },
                    { name = "Venom Strike", damage = 45, poison = true, usable = 2 },
                    { name = "Basilisk's Curse (Ultimate)", damage = 100, aoe = true, poison = true, usable = 1 }
                }
            },
            thorned_stag = {
                name = "Thorned Stag",
                ...
                attacks = {
                    ...
                    { name = "Thorn Burst", damage = 35, aoe = true, usable = 4 },
                    { name = "Camouflage", dodge_next = true, usable = 3 },
                    { name = "Branch Slam", damage = 50, usable = 2 },
                    { name = "Forest Storm (Ultimate)", damage = 110, aoe = true, reduce_attack = 20, usable = 1 }
                }
            },
            terra_wurm = {
                name = "Terra Wurm",
                ...
                attacks = {
                    ...
                    { name = "Ground Collapse", damage = 30, aoe = true, usable = 4 },
                    { name = "Sand Shift", reduce_speed = 20, usable = 3 },
                    { name = "Earth Fang", damage = 50, usable = 2 },
                    { name = "Wurmquake (Ultimate)", damage = 120, aoe = true, usable = 1 }
                }
            },
            earth_elemental = {
                ...
                attacks = {
                    ...
                    { name = "Quaking Smash", damage = 35, aoe = true, usable = 4 },
                    { name = "Earthen Armor", reduce_damage = 40, duration = 2, usable = 3 },
                    { name = "Terra Crush", damage = 50, usable = 2 },
                    { name = "Elemental Wrath (Ultimate)", damage = 120, aoe = true, increase_defense = true, duration = 2, usable = 1 }
                }
            }
        }
    },
        ...
        creatures = {
            thunderbird = {
                ...
                attacks = {
                    ...
                    { name = "Electro Shock", damage = 30, stun = true, duration = 1, usable = 4 },
                    { name = "Sky Dive", damage = 40, usable = 3 },
                    { name = "Thunder Strike", damage = 50, aoe = true, usable = 2 },
                    { name = "Stormcaller (Ultimate)", damage = 120, aoe = true, reduce_speed = 20, usable = 1 }
                }
            },
            sky_serpent = {
                name = "Sky Serpent",
                ...
                attacks = {
                    ...
                    { name = "Coiling Crush", damage = 30, paralyze = true, duration = 1, usable = 5 },
                    { name = "Cyclone Shot", damage = 40, aoe = true, usable = 3 },
                    { name = "Fang Strike", damage = 50, usable = 2 },
                    { name = "Aerial Wrath (Ultimate)", damage = 110, aoe = true, increase_evasion = true, duration = 2, usable = 1 }
                }
            },
            storm_falcon = {
                name = "Storm Falcon",
                ...
                attacks = {
                    ...
                    { name = "Bolt Dive", damage = 30, stun = true, duration = 1, usable = 5 },
                    { name = "Wing Gust", damage = 35, aoe = true, usable = 3 },
                    { name = "Hurricane Sweep", damage = 50, reduce_accuracy = true, usable = 2 },
                    { name = "Tempest Break (Ultimate)", damage = 120, aoe = true, stun_all = true, usable = 1 }
                }
            },
            wind_elemental = {
                name = "Wind Elemental",
                ...
                attacks = {
                    ...
                    { name = "Whirlwind Crush", damage = 30, aoe = true, usable = 4 },
                    { name = "Wind Shield", reduce_damage = 30, duration = 2, usable = 3 },
                    { name = "Air Slice", damage = 45, usable = 2 },
                    { name = "Tornado Burst (Ultimate)", damage = 110, aoe = true, increase_speed = true, usable = 1 }
                }
            },
            lightning_wolf = {
                name = "Lightning Wolf",
                ...
                attacks = {
                    ...
                    { name = "Electric Howl", damage = 35, aoe = true, reduce_speed = 20, usable = 4 },
                    { name = "Flash Sprint", avoid_next = true, increase_speed = true, usable = 3 },
                    { name = "Volt Strike", damage = 50, usable = 2 },
                    { name = "Storm Surge (Ultimate)", damage = 120, aoe = true, paralyze_all = true, duration = 1, usable = 1 }
                }
            },
            cloud_drake = {
                name = "Cloud Drake",
                ...
                attacks = {
                    ...
                    { name = "Lightning Bolt", damage = 40, stun = true, duration = 1, usable = 3 },
                    { name = "Sky Barrage", damage = 50, aoe = true, usable = 2 },
                    { name = "Tempest Fury (Ultimate)", damage = 120, aoe = true, stun_all = true, usable = 1 }
                }
            },
            gale_hawk = {
                name = "Gale Hawk",
                ...
                attacks = {
                    ...
                    { name = "Hurricane Fury (Ultimate)", damage = 110, aoe = true, increase_evasion = true, duration = 2, usable = 1 }
                }
            },
            zephyr_spirit = {
                name = "Zephyr Spirit",
                ...
                attacks = {
                    ...
                    { name = "Zephyr's Wrath (Ultimate)", damage = 100, aoe = true, increase_speed = true, duration = 2, usable = 1 }
                }
            }
        }
    },
        ...
        creatures = {
            shadow_assassin = {
                ...
                attacks = {
                    ...
                    { name = "Eclipse (Ultimate)", damage = 120, aoe = true, blind = true, duration = 1, usable = 1 }
                }
            },
            abyssal_wraith = {
                name = "Abyssal Wraith",
                ...
                attacks = {
                    ...
                    { name = "Wraith's Curse", damage = 35, poison = true, usable = 3 },
                    { name = "Phantom Strike", damage = 50, usable = 2 },
                    { name = "Abyssal Howl (Ultimate)", damage = 110, aoe = true, fear = true, duration = 1, usable = 1 }
                }
            },
            dark_elemental = {
                name = "Dark Elemental",
                ...
                attacks = {
                    ...
                    { name = "Void Pulse", damage = 30, aoe = true, usable = 4 },
                    { name = "Dark Shield", reduce_damage=30, duration = 2, usable = 3 },
                    { name = "Nightmare Wave", damage = 45, usable = 2 },
                    { name = "Oblivion (Ultimate)", damage = 120, aoe = true, heal_all = 20, usable = 1 }
                }
            },
            cursed_lich = {
                name = "Cursed Lich",
                ...
                attacks = {
                    ...
                    { name = "Deathly Chill", damage = 50, freeze = true, usable = 2 },
                    { name = "Requiem (Ultimate)", damage = 120, aoe = true, revive_all = true, usable = 1 }
                }
            },
            night_stalker = {
                name = "Night Stalker",
                ...
                attacks = {
                    ...
                    { name = "Creeping Terror", damage = 35, fear = true, usable = 3 },
                    { name = "Dark Claw", damage = 50, usable = 2 },
                    { name = "Nightmare (Ultimate)", damage = 110, aoe = true, blind = true, duration = 1, usable = 1 }
                }
            },
            void_reaper = {
                name = "Void Reaper",
                ...
                attacks = {
                    ...
                    { name = "Void Cataclysm (Ultimate)", damage = 120, aoe = true, drain_health = true, usable = 1 }
                }
            },
            dark_familiar = {
                name = "Dark Familiar",
                ...
                attacks = {
                    ...
                    { name = "Dark Pact", absorb_damage_for_allies = true, duration = 2, usable = 3 },
                    { name = "Nightshade Strike", damage = 40, usable = 2 },
                    { name = "Familiar's Wrath (Ultimate)", damage = 100, aoe = true, heal_all = 20, usable = 1 }
                }
            }
        }
    }
